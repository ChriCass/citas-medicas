...
class UserController 
{
        ...
        try {
            switch ($role) {
                case 'doctor':
                    ...
                    if ($doctor) {
                        $especialidadModel = new \App\Models\Especialidad();
                        $especialidad = $especialidadModel->find($doctor->especialidad_id);
                        return [
    ...
    private function validateRoleSpecificFields($role, $isUpdate = false) {
        switch ($role) {
            case 'doctor':
                ...
                $especialidadModel = new \App\Models\Especialidad();
                $especialidad = $especialidadModel->find($especialidad_id);
                if (!$especialidad) {
    ...
    public function getEspecialidades($req, $res) {
        try {
            $especialidades = \App\Models\Especialidad::getAll();
